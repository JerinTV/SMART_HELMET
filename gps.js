document.addEventListener("DOMContentLoaded", function() {
    document.getElementById("verification-form").addEventListener("submit", function(event) {
        ...
        if (helmetId === validHelmetId && password === validPassword) {
            ...
            document.getElementById("verification-section").style.display = "none";  // Hide ID/password form
            document.getElementById("tracking-section").style.display = "block";  // Show map

            // Set the map source to a specific location (this example uses Kerala)
